...
// @ts-ignore
export const defaultNodes = [generateBasicNode('Node A', [200, 300], theme), generateBasicNode('Node B', [400, 300], theme)];
...
export const getData = (theme: any): Weathermap => {
    return {
        ...
        links: [generateBasicLink([defaultNodes[0], defaultNodes[1]])].map((l, i) => {l.id = `nw-link-${i}`; return l}),
        scale: [],
        settings: {
          link: {
            spacing: {
