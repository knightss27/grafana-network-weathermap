                ...
                value.paths.map((path: Path, i: number) => {
                    if (currentPath && path.id == currentPath.id) {
                        return (
                                                ...
                                                <React.Fragment>
                                                    <InlineFieldRow style={{marginTop: "4px"}}>
                                                        ...
                                                        <InlineField grow label="Y">
                                                            <Input
                                                                type='number'
                                                                onChange={(v) => updateNodePosition(i, ni, { x: node.position.x, y: v.currentTarget.valueAsNumber})}                                                           
                            ...
                            <InlineField>
                                <React.Fragment>
                                    <Button size="md" icon="plus" onClick={() => addPathNode(i)} className={styles.addNew}>Add Node</Button>    
                                    <Button size="md" variant="destructive" icon="trash-alt" onClick={() => removePath(i)} className={styles.clearAll}>Remove Path</Button>
                                </React.Fragment>
                            </InlineField>
